...
public class FirstController {
    ...
    public String submitQuery(@RequestBody String query) throws IOException {
        ...
        //SparkConf conf = new SparkConf().setAppName("firstProgram").setMaster("local");
        String sf = query.substring(0,query.length()-1);
        String g = sf.replace('+',' ');
        /*String g = "\\+";
        sf.replaceAll(g,"\\s");*/
       ...
       System.setProperty("Hadoop.home.dir","C:/Users/Administrator/Downloads/winutils-master/hadoop-2.7.1");
        ...
        String f1 = "C:/Users/Administrator/Downloads/DB-Project-UI-master/Spark-Execution-Monitor/f1.txt";
        String f2 = "C:/Users/Administrator/Downloads/DB-Project-UI-master/Spark-Execution-Monitor/f2.txt";
        String f3 = "C:/Users/Administrator/Downloads/DB-Project-UI-master/Spark-Execution-Monitor/f3.txt";
        String f4 = "C:/Users/Administrator/Downloads/DB-Project-UI-master/Spark-Execution-Monitor/f4.txt";
        ...
        int ind=-1;
        try {
            File myObj = new File("C:/Users/Administrator/Downloads/DB-Project-UI-master/Spark-Execution-Monitor/output.txt");
